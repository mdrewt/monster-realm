...
// cannot see it. The rb78 grammar in guards_tests.rs refuses ANY macro invocation between
// a reducer item boundary and a deletion-gate call, admitting only the bare standard
// string-builder spelling. Re-derive that allow-list deliberately before adding a second.
