...
//! `client_disconnected` reducer `on_disconnect` (in `server-module/src/lib.rs`) deletes the
//! player and character rows BY IDENTITY when it closes. Live-verified: `join_game` returns
