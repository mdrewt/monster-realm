...
**Extended-by:** ADR-0246 (rb-76 — the scheduler grass path is gated at the `begin_encounter` choke point through the first identity-parameterised guards wrapper; residual R-rb-46-GRASSPATH closed)
